 ...
 */
class Version20170712084447 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE project CHANGE repository_type repository_type VARCHAR(25) NOT NULL');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE project CHANGE repository_type repository_type VARCHAR(50) NOT NULL COLLATE utf8_unicode_ci');
